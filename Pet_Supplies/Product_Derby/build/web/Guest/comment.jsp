...
<html lang="en">
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            //Comment ------------------------------------------------------------------------------------
                    ...
                    loadComments();<!---Publish Comment Event Section ---->
    ...
    if (!userComment.value) {
                ...
                publishBtn.classList.remove("abled");
                    ...
                    <!----ADD POST FUNCTION---->                         function addPost() {
                    ...
                    saveComment(comment);
                    // Add comment to UI
                    addCommentToUI(comment);                    userComment.value = "";
                    publishBtn.classList.remove("abled");
  ...
  if (e.target.classList.contains("delete-btn")) {
            ...
            function dele            teComme            ntFromLocalStorage(index) {
        let commentsArray = JSON.parse(localStorage.getItem("comments")) || [];
        commentsArray.splice(index, 1);
        localStorage.setItem("comments", JSON.stringify(commentsArray));
            }

                     func            tion updateCommentCount() {
        let commentsNum = document.querySelectorAll(".parents").length;
        commentCount.textContent = commentsNum;
                    }
        ...
        const replyHTML = '<div class="reply">' +
                          ...
                          '</div>';
        repliesSection.insertAdjacentHTML("beforeend",             replyHT            ML);
            }
    ...
    if (replyForm) {
        ...
        c            ons            ole.error("Reply form not found");
    }
            }
